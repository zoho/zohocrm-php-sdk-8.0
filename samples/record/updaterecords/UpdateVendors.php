...
class UpdateVendors
{
    ...
    public static function updateVendors($moduleAPIName)
    {
        $recordOperations = new RecordOperations($moduleAPIName);
        $bodyWrapper = new BodyWrapper();
        $records = array();
        $record1 = new Record();
        $record1->setId("32231233");
        ...
        $record1->addFieldValue(Vendors::City(), "city");
        $record1->addFieldValue(Vendors::Country(), "Country");
        $record1->addFieldValue(Vendors::State(), "state");
        $record1->addFieldValue(Vendors::Street(), "street");
        $record1->addFieldValue(Vendors::ZipCode(), "zip-code");
        $record1->addFieldValue(Vendors::Description(), "description");
...
$module = "Vendors";
UpdateVendors::initialize();
UpdateVendors::updateVendors($module);