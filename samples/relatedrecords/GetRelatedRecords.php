...
class GetRelatedRecords 
{
    ...
    public static function getRelatedRecords(string $moduleAPIName, string $recordId, string $relatedListAPIName) 
    {
        ...
        $paramInstance->add(com\zoho\crm\api\relatedrecords\GetRelatedRecordsParam::page(), 1);
        $paramInstance->add(com\zoho\crm\api\relatedrecords\GetRelatedRecordsParam::perPage(), 200);
        // $paramInstance->add(com\zoho\crm\api\relatedrecords\GetRelatedRecordsParam::fields(), "id,Last_Name");
        $paramInstance->add(com\zoho\crm\api\relatedrecords\GetRelatedRecordsParam::ids(), "1055806000000308001");
...
GetRelatedRecords::getRelatedRecords("Leads", "1055806000028448052", "Products");
?>