...
use com\zoho\crm\api\relatedrecords\GetRelatedRecordsUsingExternalIDHeader;
...
class GetRelatedRecordUsingExternalId 
{
    ...
    public static function getRelatedRecordUsingExternalId(string $moduleAPIName, string $externalValue, string $relatedListAPIName, string $relatedRecordId) 
    {
        ...
        $paramInstance->add(com\zoho\crm\api\relatedrecords\GetRelatedRecordsUsingExternalIDParam::page(), 1);
        $paramInstance->add(com\zoho\crm\api\relatedrecords\GetRelatedRecordsUsingExternalIDParam::perPage(), 200);
        $paramInstance->add(com\zoho\crm\api\relatedrecords\GetRelatedRecordsUsingExternalIDParam::fields(), "id,Last_Name");
        $headerInstance = new HeaderMap();
        $headerInstance->add(GetRelatedRecordsUsingExternalIDHeader::XEXTERNAL(), $xExternal);
        $response = $relatedRecordsOperations->getRelatedRecordUsingExternalId($relatedRecordId, $externalValue, $paramInstance, $headerInstance);
...
GetRelatedRecordUsingExternalId::getRelatedRecordUsingExternalId("Leads", "External123", "Contacts", "440248254002");
?>