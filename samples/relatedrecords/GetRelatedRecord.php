...
class GetRelatedRecord 
{
    ...
    public static function getRelatedRecord(string $moduleAPIName, string $recordId, string $relatedListAPIName, string $relatedRecordId) 
    {
        $relatedRecordsOperations = new RelatedRecordsOperations($relatedListAPIName, $moduleAPIName);
        $paramInstance = new ParameterMap();
        $headerInstance = new HeaderMap();
        
        $response = $relatedRecordsOperations->getRelatedRecord($relatedRecordId, $recordId, $paramInstance, $headerInstance);
...
GetRelatedRecord::getRelatedRecord("Leads", "1055806000028448052", "Products", "1055806000000308001");
?>