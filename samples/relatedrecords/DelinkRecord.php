...
class DelinkRecord 
{
    ...
    public static function delinkRecord(string $moduleAPIName, string $recordId, string $relatedListAPIName, string $relatedRecordId) 
    {
        $relatedRecordsOperations = new RelatedRecordsOperations($relatedListAPIName, $moduleAPIName);
        $headerInstance = new HeaderMap();
        $response = $relatedRecordsOperations->delinkRecord($relatedRecordId, $recordId, $headerInstance);
...
DelinkRecord::delinkRecord("Leads", "440248254001", "Contacts", "440248254002");
?>