...
use com\zoho\crm\api\relatedrecords\GetDeletedParentRecordsRelatedRecordParam;
...
class GetDeletedParentRecordsRelatedRecord 
{
    ...
    public static function getDeletedParentRecordsRelatedRecord(string $moduleAPIName, string $recordId, string $relatedListAPIName) 
    {
		...
		$paramInstance->add(GetDeletedParentRecordsRelatedRecordParam::perPage(), 2);
		$paramInstance->add(GetDeletedParentRecordsRelatedRecordParam::ids(), "1055806000005356009");
        $response = $relatedRecordsOperations->getDeletedParentRecordsRelatedRecord($recordId, $paramInstance);
...
GetDeletedParentRecordsRelatedRecord::initialize();
GetDeletedParentRecordsRelatedRecord::getDeletedParentRecordsRelatedRecord("Leads", "1055806000028448054", "Products");
?>