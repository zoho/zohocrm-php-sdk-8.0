...
use com\zoho\crm\api\sharingrules\GetSharingRulesParam;
...
class GetSharingRules
{
    ...
    public static function getSharingRules($moduleAPIName)
    {
        $sharingRulesOperations = new SharingRulesOperations($moduleAPIName);
        $paramInstance = new ParameterMap();
        $paramInstance->add(GetSharingRulesParam::page(), 1);
        $paramInstance->add(GetSharingRulesParam::perPage(), 10);
        $response = $sharingRulesOperations->getSharingRules($paramInstance);
        if ($response != null) {
...
GetSharingRules::initialize();
$moduleAPIName = "Leads";
GetSharingRules::getSharingRules($moduleAPIName);
