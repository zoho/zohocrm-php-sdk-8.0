...
class ActivateSharingRule
{
    ...
    public static function activateSharingRule($id, $moduleAPIName)
    {
        $sharingRulesOperations = new SharingRulesOperations($moduleAPIName);
        $response = $sharingRulesOperations->activateSharingRule($id);
        if ($response != null) {
...
ActivateSharingRule::initialize();
$moduleAPIName = "Leads";
$id = "3475551001";
ActivateSharingRule::activateSharingRule($id, $moduleAPIName);
