...
class CreateSharingRules
{
    ...
    public static function createSharingRules($moduleAPIName)
    {
        ...
        $response = $sharingRulesOperations->createSharingRules($request);
        if ($response != null) {
...
CreateSharingRules::initialize();
$moduleAPIName = "Leads";
CreateSharingRules::createSharingRules($moduleAPIName);
