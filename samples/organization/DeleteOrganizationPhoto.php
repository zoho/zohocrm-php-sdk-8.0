...
use com\zoho\crm\api\org\ActionWrapper;
...
class DeleteOrganizationPhoto
{
    ...
    public static function deleteOrganizationPhoto()
    {
        $orgOperations = new OrgOperations();
        $response = $orgOperations->deleteOrganizationPhoto();
        ...
        if ($response != null) {
            ...
            if ($actionHandler instanceof ActionWrapper) {
                ...
                $actionResponses = $actionWrapper->getOrg();
...
DeleteOrganizationPhoto::deleteOrganizationPhoto();
