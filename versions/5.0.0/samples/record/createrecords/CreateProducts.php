...
class CreateProducts
{
    ...
    public static function createProducts(string $moduleAPIName)
    {
        ...
        $record1->addFieldValue(Products::ProductActive(), true);
        $vendorName = new Record();
        $vendorName->setId("3000234402340342");
        ...
        $record1->addFieldValue(Products::QtyOrdered(), 100.0);
        $record1->addFieldValue(Products::QtyInDemand(), 120.0);
        $record1->addFieldValue(Products::ReorderLevel(), '');
        $handler = new MinifiedUser();
        $handler->setId("440248000254001");
        $record1->addFieldValue(Products::Handler(), $handler);
        $record1->addFieldValue(Products::QtyInStock(), 200.0);
        //
...
CreateProducts::initialize();
CreateProducts::createProducts($moduleAPIName);