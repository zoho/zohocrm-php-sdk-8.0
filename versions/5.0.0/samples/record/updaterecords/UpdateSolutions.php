...
class UpdateSolutions
{
    ...
    public static function updateSolutions(string $moduleAPIName)
    {
        $recordOperations = new RecordOperations($moduleAPIName);
        $bodyWrapper = new BodyWrapper();
        $records = array();
        $record1 = new Record();
        $record1->setId("3403243043423");
        ...
        $productName->setId("3034243332");
        $record1->addFieldValue(Solutions::ProductName(), $productName);
        $record1->addFieldValue(Solutions::SolutionNumber(), "32033233203233");
...
UpdateSolutions::initialize();
UpdateSolutions::updateSolutions($moduleAPINAme);