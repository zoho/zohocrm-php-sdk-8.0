...
class UpdateQuotes
{
    ...
    public static function updateQuotes($moduleAPIName)
    {
        $recordOperations = new RecordOperations($moduleAPIName);
        $bodyWrapper = new BodyWrapper();
        $records = array();
        $record1 = new Record();
        $record1->setId("345689033423423");
        $accountName = new Record();
        $accountName->addFieldValue(Accounts::id(), "304904089932");
...
UpdateQuotes::updateQuotes($moduleAPIName);