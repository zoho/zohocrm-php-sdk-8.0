...
class DeactivateSharingRule
{
    ...
    public static function deactivateSharingRule($id, $moduleAPIName)
    {
        $sharingRulesOperations = new SharingRulesOperations($moduleAPIName);
        $response = $sharingRulesOperations->deactivateSharingRule($id);
        if ($response != null) {
...
DeactivateSharingRule::initialize();
$moduleAPIName = "Leads";
$id = "347751001";
DeactivateSharingRule::deactivateSharingRule($id, $moduleAPIName);
