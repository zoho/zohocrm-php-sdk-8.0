...
class ImageUpload implements Model
{
	 ...
	 * @return string A string representing the previewIdS
	 */
	 ...
	 * @return string A string representing the descriptionS
	 */
	 ...
	 * @return string A string representing the sequenceNumberS
	 */
	 ...
	 * @return string A string representing the stateS
	 */
