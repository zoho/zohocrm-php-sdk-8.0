...
class Calls
{
	...
	public static final function OutgoingCallStatus()
	{
		return new Field('Outgoing_Call_Status'); 
	...
	public static final function VoiceRecordingS()
	{
		return new Field('Voice_Recording__s'); 
	...
	public static final function ScheduledInCRM()
	{
		return new Field('Scheduled_In_CRM'); 
