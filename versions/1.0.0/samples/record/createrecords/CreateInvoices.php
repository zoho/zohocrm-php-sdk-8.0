...
class CreateInvoices
{
    ...
    public static function createInvoices($moduleAPIName)
    {
        ...
        $accountName->addFieldValue(Accounts::id(), "34000123423423");
        ...
        $dealName = new Record();
        $dealName->setId("440248001177050");
        $record1->addKeyValue("Deal_Name__s", $dealName);
        $sales_order = new Record();
        $sales_order->addFieldValue(Sales_Orders::id(), "300034352342");
...
CreateInvoices::initialize();
CreateInvoices::createInvoices($moduleAPIName);
