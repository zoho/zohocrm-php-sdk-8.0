...
class CreateCases
{
    ...
    public static function createCases($moduleAPIName)
    {
        ...
        $productName->setId("440248001307052");
        ...
        $record1->addFieldValue(Cases::Phone(), "30002110003");
        $contactName = new Record();
        $contactName->setId("440248001306013");
        ...
        $dealName = new Record();
        $dealName->addKeyValue("id", "440248001103110");
...
$moduleAPIName = "Cases";
CreateCases::initialize();
CreateCases::createCases($moduleAPIName);