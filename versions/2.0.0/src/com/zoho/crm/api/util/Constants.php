...
class Constants
{
    ...
    const PARSE_RESPONSE = "Exception in parsing token response";
    const PACKAGE_NAMESPACE = "com\\zoho\\crm\\api";
    const REVOKE_TOKEN_ERROR = "Exception while revoke the refresh token.";
    const REVOKE_URL = "/revoke";
    const REFRESH_TOKEN_REMOVED = "Refresh token revoked successfully";
    const TOKEN_NOT_FOUND = " No tokens exist for the given user-id.";
    ...
    const GET_TOKEN_BY_USER_NAME_ERROR = "Exception in getToken() - OAuthToken : Given user_name token details not found, Please give required item";
    const PROXY_HOST = "Host: ";
    const PROXY_PORT = "Port: ";
    const PROXY_USER = "User: ";
    const ACCESS_TOKEN_USING_REFRESH_TOKEN_MESSAGE = "Access token can be generated by refresh token";
    const ACCESS_TOKEN_USING_GRANT_TOKEN_MESSAGE = "Access token can be generated by grant token.";
    ...
    const MODULE_NAMESPACE = "com\\zoho\\crm\\api\\modules\\Modules";
    ...
    const GET_TOKEN_FILE_ERROR1 = "Exception in FileStore : Check File authentication details.";
    ...
    const GET_TOKEN_DB_ERROR1 = "Exception in DBStore : Check DB authentication details.";
    ...
    const CONTENT_TYPE_1 = "Content-Type";
    const CONTENT_TYPE_2 = "ontent-Type";
    const NAME = "name";
    const VALUES = "values";
    const TYPE = "type";
    ...
    const CONTENT_DISPOSITION2 = 'content-disposition';
    ...
    const USER_NAMESPACE = "com\\zoho\\crm\\api\\users\\MinifiedUser";
    ...
    const OAUTH_MANDATORY_KEYS2 = array(Constants::GRANT_TOKEN, Constants::REFRESH_TOKEN);
    const OAUTH_MANDATORY_KEYS1 = array(Constants::CLIENT_ID, Constants::CLIENT_SECRET);
    const NOTES = "Notes";
    ...
    const EVENTS = "events";
    const LAYOUT = "layout";
    const LAYOUT_NAMESPACE = "com\\zoho\\crm\\api\\layouts\\Layouts";
    ...
    const SET_CONTENT_TYPE_HEADER = array("/crm/v8/upload");
    const DATA_TYPE = array("List" => "array", "Boolean" => "boolean", "Long" => "string", "HashMap" => "array", "array" => "Map", "Map" => "array", "Float" => "double", "Date"=>"DateTime", "TimeZone"=>"DateTimeZone", "LocalTime"=>"DateTime");
    const DOUBLE_NAMESPACE = "double";
    const TIMEZONE_NAMESPACE = "TimeZone";
    const LOCALTIME_NAMESPACE = "LocalTime";
    ...
    const GENERATE_TOKEN_ID_ERROR = "Exception in generateId() - DBStore";
    ...
    const OAUTH_TOKEN_FIELDS = array("clientID", "clientSecret","refreshToken", "redirectURL", "grantToken", "accessToken", "expiresIn", "userSignature", "id");
	const AU_DATACENTER = ["https://www.zohoapis.com.au", "https://sandbox.zohoapis.com.au", "https://developer.zohoapis.com.au", "https://accounts.zoho.com.au/oauth/v2/token","au"];
	const CN_DATACENTER = ["https://www.zohoapis.com.cn", "https://sandbox.zohoapis.com.cn", "https://developer.zohoapis.com.cn", "https://accounts.zoho.com.cn/oauth/v2/token","cn"];
	const EU_DATACENTER = ["https://www.zohoapis.eu", "https://sandbox.zohoapis.eu", "https://developer.zohoapis.eu", "https://accounts.zoho.eu/oauth/v2/token","eu"];
    ...
    const SA_DATACENTER = ["https://www.zohoapis.sa", "https://sandbox.zohoapis.sa", "https://developer.zohoapis.sa", "https://accounts.zoho.sa/oauth/v2/token", "sa"];
	...
	const ENVIRONMENT_ERROR_RESPONSE = "Exception in set the api environment.";
    const REFRESH_TOKEN_ERROR = "Exception in refresh the Access token : ";
    const ACCESS_TOKEN_ERROR = "Exception in generate Access token method: ";
    const CURRENTUSER = "CurrentUser";
    const PARAM_EXCEPTION = "Exception in forming request Parameter : ";
	const HEADER_EXCEPTION = "Exception in forming request Header : ";
    const TIME_RANGE_NAMESPACE = "com\\zoho\\crm\\api\\record\\TimeRange";
	const SUB_TYPE = "sub_type";
    const SUB_TYPE_1 = "sub_type_1";
    const BODY = "body";
	const FUNCTIONS = "v8/functions";
	const FUNCTIONS_PATH = "/actions/execute";
}
?>