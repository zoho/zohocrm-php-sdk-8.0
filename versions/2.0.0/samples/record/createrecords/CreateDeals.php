...
class CreateDeals
{
    ...
    public static function createDeals(string $moduleAPIName)
    {
...
$moduleAPIName = "Deals";
CreateDeals::initialize();
CreateDeals::createDeals($moduleAPIName);