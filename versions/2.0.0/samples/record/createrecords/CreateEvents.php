...
class CreateEvents
{
    ...
    public static function createEvents($moduleAPIName)
    {
        ...
        $participant1->setId("440248000254001");
        ...
        $record1->addFieldValue(Events::AllDay(), true);
...
CreateEvents::createEvents($moduleAPIName);