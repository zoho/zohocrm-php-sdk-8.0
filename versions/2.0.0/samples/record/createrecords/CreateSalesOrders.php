...
class CreateSalesOrders
{
    ...
    public static function createSalesOrders($moduleAPIName)
    {
        ...
        $account = new Record();
        $account->setId("440248001179025");
        $record1->addFieldValue(Sales_Orders::AccountName(), $account);
        $record1->addFieldValue(Sales_Orders::Subject(), "new Order");
        $record1->addFieldValue(Sales_Orders::Adjustment(), 10.0);
        $record1->addFieldValue(Sales_Orders::Description(), "description");
        $record1->addFieldValue(Sales_Orders::TermsAndConditions(), "details of terms and Conditiond");
        $record1->addFieldValue(Sales_Orders::CustomerNo(), "123123");
        $quoteName = new Record();
        $quoteName->setId("34004523423423");
        $record1->addFieldValue(Sales_Orders::QuoteName(), $quoteName);
        $record1->addFieldValue(Sales_Orders::Pending(), null);
        $record1->addFieldValue(Sales_Orders::Carrier(), new Choice("FedEX"));
        $record1->addFieldValue(Sales_Orders::SalesCommission(), 40.0);
        $record1->addFieldValue(Sales_Orders::PurchaseOrder(), null);
        ...
        $contact_name->setId("34500900324");
        $record1->addFieldValue(Sales_Orders::ContactName(), $contact_name);
        $record1->addFieldValue(Sales_Orders::DueDate(), new \DateTime('2023-08-10'));
        $inventoryLineItemList = array();
        $inventoryLineItem = new Record();
        $lineItemProduct = new LineItemProduct();
        $lineItemProduct->setId("440248001326058");
        ...
        $record1->addFieldValue(Sales_Orders::OrderedItems(), $inventoryLineItemList);
        $lineTaxes = array();
        $lineTax = new LineTax();
        ...
        // Address info
        $record1->addFieldValue(Sales_Orders::BillingCity(), "city");
        $record1->addFieldValue(Sales_Orders::BillingState(), "state");
        $record1->addFieldValue(Sales_Orders::BillingCountry(), "country");
        $record1->addFieldValue(Sales_Orders::BillingCode(), "code");
        $record1->addFieldValue(Sales_Orders::BillingStreet(), "street");
        $record1->addFieldValue(Sales_Orders::ShippingState(), "state");
        $record1->addFieldValue(Sales_Orders::ShippingCity(), "city");
        $record1->addFieldValue(Sales_Orders::ShippingCountry(), "country");
        $record1->addFieldValue(Sales_Orders::ShippingStreet(), "street");
        $record1->addFieldValue(Sales_Orders::ShippingCode(), "code");
...
CreateSalesOrders::initialize();
CreateSalesOrders::createSalesOrders($moduleAPIName);