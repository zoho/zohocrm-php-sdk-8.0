...
class CreateCalls
{
    ...
    public static function createCalls($moduleAPIName)
    {
        ...
        // Schedule a call
        $whoId = new Record();
        $whoId->setId("440248001306013");
        $record1->addFieldValue(Calls::WhoId(), $whoId);
        $whatId = new Record();
        $whatId->setId("440248001331009");
        ...
        $record1->addFieldValue(Calls::Reminder(), new Choice("None"));
        ...
        // log a call
        $whoId1 = new Record();
        $whoId1->setId("440248001030088");
        $record1->addFieldValue(Calls::WhoId(), $whoId1);
        $whatId1 = new Record();
        $whatId1->setId("440248001179025");
        ...
        $record1->addFieldValue(Calls::CallStartTime(), date_create("2023-04-02T11:03:06+05:30")->setTimezone(new \DateTimeZone(date_default_timezone_get())));
        $record1->addFieldValue(Calls::CallPurpose(), new Choice("Demo"));
        $record1->addFieldValue(Calls::CallAgenda(), "agenda to make call");
...
CreateCalls::createCalls($moduleAPIName);