...
class RerunSharingRules
{
    ...
    public static function rerunSharingRules($moduleAPIName)
    {
        $sharingRulesOperations = new SharingRulesOperations($moduleAPIName);
        $response = $sharingRulesOperations->rerunSharingRules();
        if ($response != null) {
...
RerunSharingRules::initialize();
$moduleAPIName = "Leads";
RerunSharingRules::rerunSharingRules($moduleAPIName);
