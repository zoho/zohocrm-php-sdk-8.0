...
class UpdateRecordUsingExternalId
{
    ...
    public static function updateRecordUsingExternalId(string $moduleAPIName, string $externalFieldValue)
    {
        ...
        $fileDetail2->setFileIdS("ae9c7cefa418ae3702f05463e2fd0a2d8c1c");
        array_push($fileDetails, $fileDetail2);
        $fileDetail3 = new FileDetails();
        $fileDetail3->setFileIdS("ae9c7cefa41ac9afc0f7433dd2098c");
        ...
        $response = $recordOperations->updateRecordUsingExternalId($externalFieldValue, $request, $headerInstance);
        if ($response != null) {
