...
class UpdateSalesOrders
{
    ...
    public static function updateSalesOrders($moduleAPIName)
    {
        ...
        $record1->setId("3223099999909323");
        $account = new Record();
        $account->setId("345003230032");
        ...
        $record1->addFieldValue(Sales_Orders::DueDate(), new \DateTime('2023-08-10'), 'y-m-d');
...
UpdateSalesOrders::updateSalesOrders($moduleAPIName);