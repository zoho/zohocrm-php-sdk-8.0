...
class UpdatePurchaseOrders
{
    ...
    public static function updatePurchaseOrders($moduleAPIName)
    {
        $recordOperations = new RecordOperations($moduleAPIName);
        $bodyWrapper = new BodyWrapper();
        $records = array();
        $record1 = new Record();
        $record1->setId("340234324");
        $vendor = new Record();
        $vendor->addFieldValue(Vendors::id(), "3402354235234");
        ...
        $contactName->setId("349883034421");
...
UpdatePurchaseOrders::updatePurchaseOrders($moduleAPIName);