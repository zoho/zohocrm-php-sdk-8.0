...
class UpdateSharingRules
{
    ...
    public static function updateSharingRules($moduleAPIName)
    {
        ...
        $response = $sharingRulesOperations->updateSharingRules($request);
        if ($response != null) {
...
UpdateSharingRules::initialize();
$moduleAPIName = "Leads";
UpdateSharingRules::updateSharingRules($moduleAPIName);
